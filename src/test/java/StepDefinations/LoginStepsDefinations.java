...
public class LoginStepsDefinations {
	 ...
	 * 
	 * @When("User enters the valid {string} and {string}") public void
	 * user_enters_the_valid_and(String string, String string2) //public void
	 * user_enters_the_valid_and(String username, String password) {
	 * 
	 ...
	 * size()>0,"User navigate to home page");
	 * 
	 * }
	 * 
